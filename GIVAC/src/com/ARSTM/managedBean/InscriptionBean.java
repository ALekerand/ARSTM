...
public String genererMatricule() {
		try {
			...
			// Cas ou la base de donn�e est vide allors comencer la num�rotation par 1
	...
	public void enregistrerTout() throws JRException, IOException {
		enregistrerEtudiant();
	...
	public void enregistrerEtudiant(){
		...
		//Si la nationalit� est ivoirienne alors faire migner Typetionalit� Lacal dans l'etudiant
