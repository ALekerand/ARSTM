...
public class RequeteInscription {
	...
	/**
	 * @author A.Lekerand
	 * Permet de recuperer l'inscription de l'ann�e en cours du'un �tudiant 
	...
	/**
	 * @author A.Lekerand
	 * Permet de recup�rer l'inscription de l'�tudiant dont la scolarit� est �tablie
	 * @param numeroEtudiant
	 * @param codeAnneeScolaire
	 * @return
	 */
	...
	/**
	 * Permet de donner la liste des inscription dont la scolarit� est �tablie mais dont la scolarit� est non sold�e
	 * @author A.Lekerand
	 * @param codeAnneeScolaire
	 * @return
	 */
